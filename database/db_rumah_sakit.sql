...
CREATE TABLE `dokter`  (
  ...
  `spesialisasi` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- Records of dokter
-- ----------------------------
INSERT INTO `dokter` VALUES (2, 'Ayay Polynomial', 'Neurologist', 'P', 'Akihabara, Japan', 2147483647, 'doctors-1.jpg', 6);
INSERT INTO `dokter` VALUES (3, 'Iduy Flutter', 'Psychiatrist', 'L', 'Britannia, Holy Britannian Empire', 2147483647, 'doctors-2.jpg', 2);
INSERT INTO `dokter` VALUES (4, 'Alal Hadoop', 'Orthopedic Surgeon', 'L', 'Mars, Tijuana, Earth', 2147483647, 'doctors-3.jpg', 7);
...
CREATE TABLE `resep_obat`  (
  ...
  `jumlah` int NOT NULL,
  `intruksi` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
